  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        {/* Left — Image */}
        <div>
          <div className="relative h-56 sm:h-72 md:h-96 rounded-2xl overflow-hidden bg-gray-100">
            <Image
              src={animal.image}
              alt={animal.breed}
              fill
            ...
            />
            <span
              className={`absolute top-4 left-4 text-sm font-semibold px-4 py-1.5 rounded-full ${config.badge}`}
            >
          ...
          <div className="grid grid-cols-3 gap-3 mt-4">
            ...
            <div className="bg-gray-50 rounded-2xl p-4 text-center border border-gray-100">
              <FaBirthdayCake
                className="text-green-700 mx-auto mb-1"
                size={20}
              />
          ...
          <div>
            ...
            <div className="bg-green-50 border border-green-100 rounded-2xl p-4">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                This is a healthy {animal.breed} {animal.type} from{" "}
                {animal.location}, weighing {animal.weight} kg and {animal.age}{" "}
                years old. Suitable for Qurbani and meets all Islamic
                requirements.
              </p>
            </div>
          </div>
